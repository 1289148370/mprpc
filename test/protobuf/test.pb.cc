...
static void InitDefaultsscc_info_GetFriendListReponse_test_2eproto() {
  ...
  ::fixbug::GetFriendListReponse::InitAsDefaultInstance();
}
...
void GetFriendListReponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListReponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
...
GetFriendListReponse::GetFriendListReponse()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListReponse)
}
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListReponse* Arena::CreateMaybeMessage< ::fixbug::GetFriendListReponse >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListReponse >(arena);
}
